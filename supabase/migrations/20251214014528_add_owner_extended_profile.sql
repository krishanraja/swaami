-- Add extended owner profile data to task queries for PersonDetailsDrawer
-- This migration adds: skills, member_since (created_at), tasks_completed, neighbourhood

-- Update get_public_tasks to include extended owner info
...
-- Update get_nearby_tasks to include extended owner info
